...
impl Adcs {
    ...
    pub fn read(&mut self, ad_channels: &AdcChannels) {
        ...
        #[cfg(feature = "cs-op")]
        adcs.adc1.convert(&ad_channels.cc4, sample_time);
...
pub struct AdcChannels {
    ...
    #[cfg(feature = "cs-op")]
    cc1: opamp::Follower<opamp::Opamp3, ObservationToken<PB0<gpio::Analog>>, opamp::InternalOutput>,
    #[cfg(feature = "cs-op")]
    cc2:
    ...
    #[cfg(feature = "cs-op")]
    cc4: opamp::Follower<opamp::Opamp1, ObservationToken<PA1<gpio::Analog>>, opamp::InternalOutput>,
    #[cfg(feature = "cs-op")]
    cc5: opamp::Follower<opamp::Opamp2, ObservationToken<PA7<gpio::Analog>>, opamp::InternalOutput>,
